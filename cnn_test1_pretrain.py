...
some_sents = tokenizer.texts_to_sequences(['this is a good movie.','this is a bad film','i dont know!'])
flat_list = []
for sublist in some_sents:
    for item in sublist:
        flat_list.append(item)

flat_list = [flat_list]
some_X = pad_sequences(flat_list, maxlen=max_length, padding='post')
